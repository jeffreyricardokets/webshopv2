...
if __name__ == "__main__":
    ...
    def request_input_parser():
        ...
        parser_show_users = subparser.add_parser('user-list', help='create a list of all users')
        ...
        parser_create_tag.add_argument('--description')
